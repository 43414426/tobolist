...
function updateChildComponent (
  ...
  var hasChildren = !!(
    renderChildren ||               // has new public slots
...
function initProps (vm, propsOptions) {
  ...
  var loop = function ( key ) {
    ...
    // public props are already proxied on the components's prototype
...
function renderStatic (
  ...
  // public trees can be rendered once and cached on the contructor options
...
function markStatic$1 (node) {
  ...
  if (node.type === 1) {
    // do not make components slot content public. this avoids
